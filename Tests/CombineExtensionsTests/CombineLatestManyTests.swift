...
class CombineLatestManyTests: XCTestCase {
    ...
    func testValues() throws {
        ...
        let disposable = CombineLatestMany(publishers).sink(receiveCompletion: { receivedCompletion in
...
//        var values: [[Int]] = []
//        let cancellable = CombineLatestMany(publishers.enumerated().map { idx, pub in
